        ...
        if use_search:
            ...
            try:
                ...
                if augmented_context:
                    print(f"[Search] 成功获取搜索结果上文 ({len(augmented_context)} 字符)")
                else:
                    print(f"[Search] 搜索未返回结果，继续使用纯LLM回答")
            except Exception as e:
                print(f"[Search] 搜索异常: {type(e).__name__}，继续使用纯LLM回答")
                augmented_context = ""
