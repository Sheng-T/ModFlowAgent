"""
Deterministic step builder for the ont_dna local workflow.

Handles any ONT DNA modification type (5mCG, 6mA, 5hmCG, all, …)
...
Fixed output filenames: calls.bam / sorted.bam / pileup.bed / extract.tsv
