#!/usr/bin/env bash
# =============================================================================
#  EpiAgent one-click deployment script
#
...
#    4  Create agent Python env (epi_agent)          ─╯
...
_run_wizard() {
    ...
    echo -e "${_BLD}${_CYN}║       EpiAgent — Setup Wizard            ║${_RST}"
    echo -e "${_BLD}${_CYN}╚══════════════════════════════════════════╝${_RST}"
    echo ""
    ...
    _ask "Base directory for all data files" "${HOME}/epiagent" W_BASE
    ...
    cat > "${CONF_FILE}" <<EOF
# =============================================================================
#  EpiAgent deployment configuration
...
echo ""
echo -e "${_BLD}${_CYN}╔══════════════════════════════════════════╗${_RST}"
echo -e "${_BLD}${_CYN}║         EpiAgent Deployment              ║${_RST}"
echo -e "${_BLD}${_CYN}╚══════════════════════════════════════════╝${_RST}"
